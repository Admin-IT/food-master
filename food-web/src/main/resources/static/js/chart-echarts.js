            ...
            if ($("#user_type").length) {
                ...
                var option = {
                        ...
                        xAxis: [{
                            type: 'category',
                            boundaryGap: false,
                            data: ['2018-06-01', '2018-05-01', '2018-04-01', '2018-03-01', '2018-02-01'],
                            axisLine: {
                                show: true, onZero: true, lineStyle: {
                                    color: '#e77512',
                                    type: 'solid',
            ...
            if ($("#scatter_chart").length) {
                ...
                var option = {
                        ...
                        , xAxis: [{
                            ...
                            name: '2018',
                            type: 'scatter',
                            data: [[161, 51], [167, 59], [159, 49], [157, 63], [155, 53], [170, 59], [159, 47], [166, 69], [176, 66], [160, 75], [172, 55], [170, 54], [172, 62], [153, 42], [160, 50], [147, 49], [168, 49], [175, 73], [157, 47], [167, 68]],
                            markPoint: {
                                show: false, data: [{
                                    type: 'max', name: ''
                                }
                ...
                data : [
                    {type : '', name: ''}
                            ...
                            , {
                                name: '2015',
                                type: 'scatter',
                                data: [[174, 65], [175, 71], [193, 80], [186, 72], [187, 78], [181, 74], [184, 86], [184, 78], [175, 62], [184, 81], [180, 76], [177, 83], [192, 90], [176, 74], [174, 71], [184, 79], [192, 93], [171, 70], [173, 72], [176, 85]],
                                markPoint: {
                                    show: false, data: [{
                                        type: 'max', name: ''
                                    }
            ...
            if ($("#page_views_today_bar").length) {
                ...
                var option = {
                        ...
                        xAxis: [{
                            type: 'category',
                            boundaryGap: false,
                            data: ['03 march', '04 march', '05 march', '06 march', '07 march', '08 march', '09 march', '10 march', '11 march', '12 march', '13 march', '14 march'],
                            axisLine: {
                                show: true, onZero: true, lineStyle: {
                                    color: '#e77512',
                                    type: 'solid',
            ...
            if ($("#user_type_bar").length) {
                ...
                var option = {
                        ...
                        xAxis: [{
                            type: 'category',
                            boundaryGap: false,
                            data: ['2018-06-01', '2018-05-01', '2018-04-01', '2018-03-01', '2018-02-01', '2018-01-01', '2015-12-01', '2015-11-01', '2015-10-01', '2015-09-01'],
                            axisLine: {
                                show: true, onZero: true, lineStyle: {
                                    color: '#e77512',
                                    type: 'solid',
