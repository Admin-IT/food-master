        ...
        DASH_SETTINGS.chartMorris = function () {
            if ($("#morris_area_graph").length) {
                ...
                Morris.Area({
                        ...
                        ykeys: ['y', 'z'],
                        labels: ['Y', 'Z'],
                        lineColors: ['#e8962e', '#f46e0f'],
                        pointFillColors: ['#f46e0f']
                    }
            ...
            if ($("#morris_bar_graph").length) {
                ...
                Morris.Bar({
                        ...
                        ykeys: ['y', 'z', 'a'],
                        labels: ['Y', 'Z', 'A'],
                        barColors: ['#e8962e', '#3F51B5', '#f46e0f']
                    }
                ).on('click', function (i, row) {
                        console.log(i, row);
                    }
            ...
            if ($("#morris_line_graph").length) {
                ...
                Morris.Line({
                        ...
                        labels: ['Registered', 'Purchase'],
                        lineColors: ['#e8962e', '#3F51B5'],
                        pointFillColors: ['#f46e0f']
                    }
                );
            }
            if ($("#morris_donut_graph").length) {
                ...
                Morris.Donut({
                        ...
                        labelColor: '#999999',
                        colors: ["40-#e8962e-#e45131:70-#e45131-#e45131:90-#e45131", '#f7f7f7']
                    }
                );
            }
            ...
            if ($("#morris_noncontinuous_graph").length) {
                ...
                Morris.Line({
                        ...
                        lineColors: ['#e8962e', '#3F51B5'], /* custom label formatting with `xLabelFormat` */
